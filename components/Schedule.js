...
export default function Schedule({ visible, onClose, passedDate }) {
    ...
    if (item == "all") {
      ...
      try {
        const response = await axios.post(
          PORT_URL + "/getCategorizedSchedule",
          data
        );
  ...
  const deleteExpiredSchedules = async () => {
    try {
      ...
      const expiredSchedules = allSchedules.filter(
        (schedule) => new Date(schedule.date) < yesterdayDate
      );
            ...
            >
              <Text
                style={{
                  ...
                  borderRadius: 5,
                  backgroundColor:
                    category === "personal" ? "#D4F1F4" : "white",
                }}
              ...
              <Text
                style={{
                  ...
                  padding: 3,
                  borderRadius: 5,
                  backgroundColor: category === "work" ? "#D4F1F4" : "white",
                }}
              ...
              <Text
                style={{
                  ...
                  padding: 3,
                  borderRadius: 5,
                  backgroundColor: category === "family" ? "#D4F1F4" : "white",
                }}
              ...
              <Text
                style={{
                  ...
                  padding: 3,
                  borderRadius: 5,
                  backgroundColor: category === "others" ? "#D4F1F4" : "white",
                }}
            ...
            <View style={{ flexDirection: "row", alignItems: "center" }}>
              ...
              <Picker
                ...
                onValueChange={(itemValue, itemIndex) => {
                  ...
                  getCategorizedSchedule(itemValue);
                }}
              >
